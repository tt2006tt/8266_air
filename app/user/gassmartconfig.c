...
smartconfig_done(sc_status status, void *pdata)
{
    ...
    switch(status) {
        ...
        case SC_STATUS_FIND_CHANNEL:
        	...
        	UartPackege[textlen] = 0x03;textlen++;//mem 配网中
	...
	UartPackege[textlen] = UartStop;textlen++;//stop 15
			...
			//os_timer_arm(&uart_main, 2500, 1);//1.5s扫描一次
...
void gas_smartconfig()
{
	...
	//Mode = Mode_Bias;//加热传感器并且延时连接websocket
	wifi_station_disconnect();
